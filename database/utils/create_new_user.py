...
def create_new_user(user_id: int):
    ...
    This function checks if the required records for the given `user_id` exist in the 
    database. If any are missing, it creates them. This ensures that all essential 
    user-related data structures are properly initialized.
